...
Next to that, it could be interesting to find out if this trend also exists in Europe. The following cities in Europe will be analyzed: Munich, Milan, Paris, London and Dublin (*BRON*). 

The general question for this study project is as follows: 

**“*To what extent does the day of the week (weekend vs. weekday) impact pricing of Airbnb in the U.S.? And does this significantly differ per roomtype, and does this significantly differ per city/ continent?*”**

Read the generated research file by goign to XXXX(nog invullen, linkje naar het document met de resultaten)

## Method
The data used in this research project was obtained from Inside Airbnb. 
